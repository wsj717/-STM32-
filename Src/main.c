...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
    if(IsQueueEmpty(UsartFifo) != true)
    {
//      PopElement(UsartFifo, &temp_buff);
//      HAL_UART_Transmit(&huart1,temp_buff,sizeof(DataBuf),1000);
//      config_register(temp_buff);
